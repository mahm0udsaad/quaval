          ...
          <div className="mt-7 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              <div>
                ...
                <h3 className="mt-4 text-3xl font-bold text-secondary">AURORA</h3>
                <p className="mt-3 max-w-xl text-sm leading-6 text-text-light">
                  Commercial, military, and aircraft rod ends, spherical bearings, accessories,
                  engineering data, and technical resources — 128 pages.
                </p>
              </div>
              <span className="mt-6 inline-flex items-center gap-2 font-semibold text-primary">
                Browse catalog
            ...
            >
              <div>
                ...
                <h3 className="mt-4 text-3xl font-bold text-secondary">CARTER</h3>
                <p className="mt-3 max-w-xl text-sm leading-6 text-text-light">
                  Cam followers, yoke rollers, custom and stainless bearings, Hi-Rollers,
                  Neverlube products, and engineering resources — 4 pages.
                </p>
              </div>
              <span className="mt-6 inline-flex items-center gap-2 font-semibold text-primary">
                Browse catalog
            ...
            >
              <div>
                ...
                <h3 className="mt-4 text-3xl font-bold text-secondary">KRW</h3>
                <p className="mt-3 max-w-xl text-sm leading-6 text-text-light">
                  Rolling-bearing ranges, dimensions, technical guidance, accessories,
                  application data, and reference information — 298 pages.
                </p>
              </div>
              <span className="mt-6 inline-flex items-center gap-2 font-semibold text-primary">
                Browse catalog
            ...
            >
              <div>
                ...
                <h3 className="mt-4 text-3xl font-bold text-secondary">KBC</h3>
                <p className="mt-3 max-w-xl text-sm leading-6 text-text-light">
                  Ball, roller, thrust, unit, water-pump, clutch, ceramic, and vacuum bearings
                  with selection guidance, engineering data, dimensions, and load ratings — 244
                  pages.
                </p>
              </div>
              <span className="mt-6 inline-flex items-center gap-2 font-semibold text-primary">
            ...
            >
              <div>
                ...
                <h3 className="mt-4 text-3xl font-bold text-secondary">NICE</h3>
                <p className="mt-3 max-w-xl text-sm leading-6 text-text-light">
                  Precision, semi-ground, and unground ball bearings with RBC cam followers,
                  roller bearings, rod ends, self-lubricating bearings, and custom solutions —
                  60 pages.
                </p>
              </div>
              <span className="mt-6 inline-flex items-center gap-2 font-semibold text-primary">
            ...
            >
              <div>
                ...
                <h3 className="mt-4 text-3xl font-bold text-secondary">RBC</h3>
                <p className="mt-3 max-w-xl text-sm leading-6 text-text-light">
                  Thrust bearing solutions, cam followers, and spherical plain bearings with
                  product data, lubrication options, and application guidance — 200 pages.
                </p>
              </div>
              <span className="mt-6 inline-flex items-center gap-2 font-semibold text-primary">
                Browse catalogs
