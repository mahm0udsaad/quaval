...
export default function SignInPage() {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Get redirect path from searchParams or localStorage or default to home
      const redirectPath = returnUrl || localStorage.getItem("redirectPath") || "/"
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      // Note: Redirect will be handled by the AuthContext after successful sign-in
    } catch (err) {
